...
define([
    ...
    'game/sprites/background_sprite_sheet',
    ...
    return gameServices
        ...
        .factory('AssetManager', ['Global', 'Events', 'BackgroundSprite', 'GameSprite', 'SpecialEffectSprite', function (Global, Events, BackgroundSprite, GameSprite, SpecialEffectSprite) {
